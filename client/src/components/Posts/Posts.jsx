  ...
  return (
    <div className="p-6 ">
      <div className="grid grid-cols-5">
        <div className="col-span-3 overflow-auto bg-gray-100 ">
          <ItemsPost />
        </div>
            ...
            >
              ...
              <div className="flex gap-6 items-center mt-3">
                <input
                  ...
                  placeholder="search"
                />
                <button className="font-bold text-lg text-blue-500">Ok</button>
              </div>
                ...
                {users.map((u, i) => {
                  return !tags.some((t) => t.id == u._id) ? (
                    ...
                    >
                      <img
                        src={
                          u.profileImage ? u.profileImage : img_blank_profile
                        }
